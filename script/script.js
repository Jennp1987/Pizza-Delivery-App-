...
function verifyDeliveryAddress() {
    ...
    var problem = false,
        ...
        nameNotNumbRegex = /^(?![\s.]+$)[a-zA-Z\s.]*$/, /*/^[A-Za-z]+$/*/
...
function fillInBillingInfo() {
    "use strict";
    var billingAddressType = $('billingAddressType'), deliveryAddressType = $('deliveryAddressType');
...
function verifyBillingInfo() {
    ...
    var problem = false,
        ...
        nameNotNumbRegex = /^(?![\s.]+$)[a-zA-Z\s.]*$/, /* /^[A-Za-z\s]+$/*/
        billingAddressType = $('billingAddressType'),
...
function luhnTest(number) {
    ...
    var reversed = number.split('').reverse().join(''), result = "", i, sum = 0, n;
